...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/users/{id}', [UserAccountController::class, 'show']);
    Route::put('/users/{id}', [UserAccountController::class, 'update']);
    Route::delete('/users/{id}', [UserAccountController::class, 'destroy']);
    Route::post('/users/{id}/status', [UserAccountController::class, 'changeStatus']);
});